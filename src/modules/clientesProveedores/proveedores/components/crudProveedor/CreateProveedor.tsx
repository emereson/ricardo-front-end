...
const CreateProveedor = ({ isOpen, onOpenChange, findProveedores }: Props) => {
  const {
    register,
    handleSubmit,
    reset,
    ...
    defaultValues: {
      autorretiene_renta: false,
      autorretiene_iva: false,
      autorretiene_ica: false,
  ...
  // 🟢 3. Funciones para manejar las cuentas bancarias
  ...
  const handleCuentaChange = (
    ...
    // Lógica para que solo exista una cuenta principal
  ...
  const submit = (data: ProveedorType) => {
    ...
    const newData = {
      ...
      cuentasBancarias: cuentasBancarias.map(({ archivo, ...rest }) => rest),
    };
          ...
          <>
            <ModalHeader className="px-4 py-3 flex flex-col gap-1 text-lg font-bold bg-slate-900 text-white border-b border-slate-800">
              ...
              <p className="text-xs font-normal text-slate-400">
                Complete los campos a continuación para añadir un nuevo
                    ...
                    <div className="pt-2">
                      <div className="flex justify-between items-center mb-4 border-b border-slate-200 pb-2">
                        <p className="text-sm text-slate-500">
                          Añada las cuentas bancarias asociadas al proveedor.
                        </p>
                        <Button
                          size="sm"
                          className="bg-emerald-100 text-emerald-700 font-bold"
